$(function () {
    ...
    let students1 = students.slice(0, 6);
    let students2 = students.slice(6,12);
    let students3 = students.slice(12, 18);
    let students4 = students.slice(12, 18);
    ...
    */
    ...
    function render(data) {
        ...
        data.forEach(function (elem) {
            ...
            <td style="width: 90px;">${elem.lid}</td>
            <td style="width: 90px;">${elem.ltitle}</td>
            <td class="{'${elem.lstate}'=='已完成'?'state':''}" style="width: 90px;">${elem.lstate}</td>
            <td style="width: 90px;">${elem.lfaculty}</td>
            <td>${elem.ldevice}</td>
            <td style="width: 90px;">${elem.lteacher}</td>
            <td style="width: 100px;">${elem.ldate}</td>
            <td style="width: 110px;">${elem.ltime}</td>
        </tr>`
        })
        //清空子元素 文档处理 删除
        table.empty();
